<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewItems.aspx.cs" Inherits="NewItems" %>
    ...
    <div class="wrapper">
      <ul id="menu" class="clearfix">
        ...
        <li class="active"><a href="product.aspx">Product</a></li>
            ...
            <div id='cssmenu'>
           <ul>
                <li class="active"> <asp:LinkButton ID="LinkButton1" runat="server" 
                                    CausesValidation="False" Font-Bold="True" Font-Size="Medium">New</asp:LinkButton>
                </li>
                ...
                <li> <asp:LinkButton ID="LinkButton3" runat="server"  
                        ...
                        Font-Size="Medium" PostBackUrl="~/RepairedItems.aspx">Repaired</asp:LinkButton>
               </li>
                <li> <asp:LinkButton ID="LinkButton4" runat="server" Font-Bold="True" 
                                    CausesValidation="False" PostBackUrl="~/Product.aspx"
                              Font-Size="Medium">View All Product</asp:LinkButton>
                </li>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="new" Name="Category" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
