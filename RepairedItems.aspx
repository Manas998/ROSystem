<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RepairedItems.aspx.cs" Inherits="RepairedItems" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>RepairedItems</title>
      ...
      <ul id="menu" class="clearfix">
        ...
        <li class="active"><a href="product.aspx">Product</a></li>
           ...
           <ul>
                ...
                <li class="active"> <asp:LinkButton ID="LinkButton3" runat="server"  
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="repaired" Name="Category" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
